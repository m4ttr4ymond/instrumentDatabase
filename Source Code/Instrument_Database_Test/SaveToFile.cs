...
namespace Instrument_Database_Test
{
    ...
    class SaveToFile
    {
        ...
        public static void serializeAll()
        {
            ...
            catch (Exception) { Console.WriteLine("Save exception"); }
            ...
            switch (i)
            {
                ...
                case 1:
                    //try
                    {
                        ...
                        using (MemoryStream reader = new MemoryStream(Encoding.Unicode.GetBytes(decryptFile(Form1.filepath + "\\StudentData.xml"))))
                            Form1.students = (BindingList<StudentData>)loader.Deserialize(reader);
                    }
                    //catch (Exception) { Console.WriteLine("Load exception"); }
                    break;
